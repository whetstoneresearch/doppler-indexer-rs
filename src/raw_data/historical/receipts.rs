...
#[derive(Debug)]
pub(crate) struct FullReceiptRecord {
    pub(crate) block_number: u64,
    pub(crate) block_timestamp: u64,
    pub(crate) transaction_hash: [u8; 32],
    pub(crate) transaction_index: u32,
    pub(crate) from_address: [u8; 20],
    pub(crate) to_address: Option<[u8; 20]>,
    pub(crate) cumulative_gas_used: u64,
    pub(crate) gas_used: u64,
    pub(crate) contract_address: Option<[u8; 20]>,
    pub(crate) status: bool,
    pub(crate) log_count: u32,
}

#[derive(Debug)]
pub(crate) struct MinimalReceiptRecord {
    pub(crate) block_number: u64,
    pub(crate) block_timestamp: u64,
    pub(crate) transaction_hash: [u8; 32],
    pub(crate) from_address: [u8; 20],
...
impl ChannelMetrics {
    ...
    pub(crate) fn log_summary(&self, channel_name: &str) {
...
pub(crate) async fn send_range_complete(
...
pub(crate) struct BatchFetchResult {
    ...
    pub(crate) full_records: Vec<FullReceiptRecord>,
    pub(crate) logs: Vec<LogData>,
    pub(crate) rpc_time: std::time::Duration,
...
pub(crate) fn write_minimal_receipts_to_parquet(
...
pub(crate) fn write_full_receipts_to_parquet(
