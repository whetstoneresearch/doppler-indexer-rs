...
use crate::storage::paths::{decoded_eth_calls_dir, raw_eth_calls_dir};
...
pub async fn decode_eth_calls(
    ...
    let output_base = decoded_eth_calls_dir(&chain.name);
    ...
    let raw_calls_dir = raw_eth_calls_dir(&chain.name);
