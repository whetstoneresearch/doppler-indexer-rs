...
pub const V4_MULTICURVE_CREATE_HANDLER_NAME: &str = "V4MulticurveCreateHandler";
pub const V4_MULTICURVE_CREATE_HANDLER_VERSION: u32 = 1;
pub const V4_MULTICURVE_CREATE_HANDLER_SCOPE: VersionedSource = VersionedSource::new(
    V4_MULTICURVE_CREATE_HANDLER_NAME,
    V4_MULTICURVE_CREATE_HANDLER_VERSION,
);
